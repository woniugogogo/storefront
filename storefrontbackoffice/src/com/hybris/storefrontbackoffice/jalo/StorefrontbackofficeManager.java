 ...
 */
public class StorefrontbackofficeManager extends GeneratedStorefrontbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StorefrontbackofficeManager.class.getName());
	 ...
	 */
	public static StorefrontbackofficeManager getInstance()
	{
		return (StorefrontbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(StorefrontbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StorefrontbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StorefrontbackofficeManager called.");
		}
	}
